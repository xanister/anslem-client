...
(function ($) {
    ...
    $.keyboard = function (el, options) {
        ...
        base.bindKeyboard = function () {
            ...
            base.$preview
                    ...
                    .bind('keypress.keyboard', function (e) {
                        ...
                        if (o.restrictInput) {
                            ...
                            if ((e.which === 8 || e.which === 0) && $.inArray(e.keyCode, base.alwaysAllowed)) {
                                return;
                            }
                            // quick key check
            ...
            if (o.preventPaste) {
                base.$preview.bind('contextmenu.keyboard', function (e) {
                    e.preventDefault();
                });
                base.$el.bind('contextmenu.keyboard', function (e) {
                    e.preventDefault();
                });
            }
        ...
        base.bindKeys = function () {
            ...
            base.$allKeys = base.$keyboard.find('button.ui-keyboard-button')
                    ...
                    .bind(o.keyBinding.split(' ').join('.keyboard ') + '.keyboard repeater.keyboard', function (e) {
                        ...
                        if (timer - (base.last.eventTime || 0) < o.preventDoubleEventTime) {
                            return;
                        }
                    ...
                    .bind('mouseenter.keyboard mouseleave.keyboard touchstart.keyboard', function (e) {
                        ...
                        // remove duplicates
                        $this.data('layers', txt = $.grep(txt, function (v, k) {
                    ...
                    .bind('mouseup.keyboard mouseleave.kb touchend.kb touchmove.kb touchcancel.kb', function (e) {
                        if (/(mouseleave|touchend|touchcancel)/i.test(e.type)) {
                            ...
                            if (base.isVisible() && base.isCurrent()) {
                                base.$preview.focus();
                            }
                            if (base.checkCaret) {
                                base.$preview.caret(base.last);
